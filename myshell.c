...
static void decomposePATH ()
{
    ...
    if (PATH)
    {
        ...
        fprintf(stderr, "PATH environment variable decomposed\n");
        free(pathTmp);
    }
    else
    {
...
void __init__ (char** env)
{
    ...
    if (PATH)
    {
        fprintf(stderr, "PATH environment variable exists\n");
    ...
    if (HOME)
    {
        ...
        fprintf(stderr, "HOME environment variable exists\n");
    ...
    if (0 == chdir(HOME))
    {
        fprintf(stderr, "Change to current directory to HOME\n");
    }
    else
    {
        fprintf(stderr, "Change to current directory to HOME\n");
    ...
    if (LOGNAME)
    {
        ...
        fprintf(stderr, "LOGNAME environment variable exists\n");
